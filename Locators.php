...
<p id="line1"> Capture this text and print it in the console. (using tag#id) </p>
...
<p class="example line2"> Capture this text and print it in the console. (using tag.class) </p>
